...
import net.dv8tion.jda.api.events.session.ReadyEvent; // JDA 5 moved ReadyEvent under events.session
        ...
        if (guildId != null && !guildId.isEmpty()) {
            ...
            if (guild != null) {
                ...
                guild.upsertCommand("say", "마인크래프트 서버 채팅으로 전송")
                        .addOption(net.dv8tion.jda.api.interactions.commands.OptionType.STRING, "message", "보낼 메시지", true)
                        .queue();
